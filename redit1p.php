...
<body bgcolor= "#a8d7ff" background= "./img/rD000.gif">
	<div>
		<div class="avtor">
		<a href="adminpanel.php" class="url-min" title="Наш сайт"></a>
		  </div>
		  <title>бланки</title>
		<?php
...
while( $row = mysql_fetch_array($res1))
		...
		<form method="post" action="redit1p.php">

		<p class="no-print">
		<input type="text" name="searchText" size="1" value=""/>
		<input type="submit" name="searchBtn" size="1" value=""/> 
		</p>
		<?php
		showIt();
		?>
