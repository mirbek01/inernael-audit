...
</head><body bgcolor= "#01DFD7" background= "./img/rD000.gif"></body>
...
{
$name = $_POST['id'];
if(mysql_query("INSERT INTO auditold VALUES('','$name')"))
	echo "Successful Insertion!";
else
	echo "Please try again";
}
$res1 = mysql_query("SELECT * FROM auditold");
...
function showIt()
{
	...
	mysql_select_db('host_29723_mirbase') or die('db not selected'); 
mysql_set_charset("utf8");
	$sql1 = "select * from auditold t where t.id like '%".$names."%'";
...
<td><br> <b>	Описание№8	<b>: &nbsp;&nbsp;&nbsp;&nbsp;</td> <td> " .$row[	29	]."<br/><big><a href='redit1011.php?edit=$row[id]'>edit</a></big></td></tr><b><u>_________________________________________________________________________________________________________________________________________________</b></u><br>";	 
...
<form method="post" action="redit1old.php">
