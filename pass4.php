...
{
$name = $_GET['edit'];
$res4 = mysql_query("SELECT * FROM net4 WHERE name='$name'");
...
$name = $_POST['name'];
$sql4 = "UPDATE net4 SET name='$newName' WHERE name='$name'";
$res4 = mysql_query($sql4) or die("Could not update" .mysql_error()); 
