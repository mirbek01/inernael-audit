...
ИдентификаторID <br> <input type = "text" name="newName0" size="70"value="<?php  echo $row0[0];?>"><br/>
Audittype <br> <input type = "text" name="newName1" size="70"value="<?php  echo $row0[1];?>"><br/>
# <br> <input type = "text" name="newName2" size="70"value="<?php  echo $row0[2];?>"><br/>
Номеротчета <br> <input type = "text" name="newName3" size="70"value="<?php  echo $row0[3];?>"><br/>
Аудитна <br> <input type = "text" name="newName4" size="70"value="<?php  echo $row0[4];?>"><br/>
Наименованиеотчета <br> <input type = "text" name="newName5" size="70"value="<?php  echo $row0[5];?>"><br/>
РешениеПравления <br> <input type = "text" name="newName6" size="70"value="<?php  echo $row0[6];?>"><br/>
Датаотчета <br> <input type = "text" name="newName7" size="70"value="<?php  echo $row0[7];?>"><br/>
Нарушение <br> <input type = "text" name="newName8" size="70"value="<?php  echo $row0[8];?>"><br/>
Мероприятие <br> <input type = "text" name="newName9" size="70"value="<?php  echo $row0[9];?>"><br/>
Ответственноеподразделение <br> <input type = "text" name="newName10" size="70"value="<?php  echo $row0[10];?>"><br/>
Аудиторы <br> <input type = "text" name="newName11" size="70"value="<?php  echo $row0[11];?>"><br/>
Линиякомпетенции <br> <input type = "text" name="newName12" size="70"value="<?php  echo $row0[12];?>"><br/>
Рейтинг <br> <input type = "text" name="newName13" size="70"value="<?php  echo $row0[13];?>"><br/>
Первоначальная Датаисполнения <br> <input type = "text" name="newName14" size="70"value="<?php  echo $row0[14];?>"><br/>
Статус <br> <input type = "text" name="newName15" size="70"value="<?php  echo $row0[15];?>"><br/>
Новаядатаисполнения <br> <input type = "text" name="newName17" size="70"value="<?php  echo $row0[16];?>"><br/>
monitoringperiod <br> <input type = "text" name="newName18" size="70"value="<?php  echo $row0[17];?>"><br/>
рассылка <br> <input type = "text" name="newName19" size="70"value="<?php  echo $row0[18];?>"><br/>
эл.адресрассылки <br> <input type = "text" name="newName20" size="70"value="<?php  echo $row0[19];?>"><br/>
Комментарии <br> <input type = "text" name="newName21" size="70"value="<?php  echo $row0[20];?>"><br/>
Необходимыекорректирующиемеры <br> <input type = "text" name="newName22" size="70"value="<?php  echo $row0[21];?>"><br/>
Описание№1 <br> <input type = "text" name="newName23" size="70"value="<?php  echo $row0[22];?>"><br/>
Описание№2 <br> <input type = "text" name="newName24" size="70"value="<?php  echo $row0[23];?>"><br/>
Описание№3 <br> <input type = "text" name="newName25" size="70"value="<?php  echo $row0[24];?>"><br/>
Описание№4 <br> <input type = "text" name="newName26" size="70"value="<?php  echo $row0[25];?>"><br/>
Описание№5 <br> <input type = "text" name="newName27" size="70"value="<?php  echo $row0[26];?>"><br/>
Описание№6 <br> <input type = "text" name="newName28" size="70"value="<?php  echo $row0[27];?>"><br/>
Описание№7 <br> <input type = "text" name="newName29" size="70"value="<?php  echo $row0[28];?>"><br/>
Описание№8 <br> <input type = "text" name="newName30" size="70"value="<?php  echo $row0[29];?>"><br/>
